...
#reading file
df = pd.read_csv(r"C:\Users\sheac\ChrisProject1\M5_RNA\M5RNAmatches.csv")
...
#heatmap generation
fig = px.imshow(df, color_continuous_scale='greens', labels=dict(x="Species (% Abundance)", y="Pipeline number", color="Proportion"))
fig.show()
