...
#reading file
df = pd.read_csv(r"C:\Users\sheac\ChrisProject1\M6_DNA\M6DNAmatches.csv")
...
#heatmap generation
fig = px.imshow(df, color_continuous_scale='redor', labels=dict(x="Species (% Abundance)", y="Pipeline number", color="Proportion"))
fig.show()
