...
#reading file
df = pd.read_csv(r"C:\Users\sheac\ChrisProject1\M6_RNA\M6RNAmatches.csv")
...
#heatmap generation
fig = px.imshow(df, color_continuous_scale='reds', labels=dict(x="Species (% Abundance)", y="Pipeline number", color="Proportion"))
fig.show()
