...
#reading file
df = pd.read_csv(r"C:\Users\sheac\ChrisProject1\M4_DNA\M4DNAmatches.csv")
...
#heatmap generation
fig = px.imshow(df, color_continuous_scale='tealgrn', labels=dict(x="Species (% Abundance)", y="Pipeline number", color="Proportion"))
fig.show()
